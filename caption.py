...
def caption_images(encoder_path, decoder_path, word_map_path, test_folder, output_csv, beam_size=3):
    """
    Caption images and create a submission file.
    
    :param encoder_path: path to trained encoder
    :param decoder_path: path to trained decoder
...
def main():
    parser = argparse.ArgumentParser(description='Caption images and create submission file.')
    parser.add_argument('--encoder', type=str, required=True, help='Path to trained encoder')
    parser.add_argument('--decoder', type=str, required=True, help='Path to trained decoder')
